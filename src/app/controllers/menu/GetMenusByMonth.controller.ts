...
export class GetMenusByMonthController implements Controller {
  public async run(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const menus = await menuFinder.findByMonth(new Date(date));
      ...
      errorHandler(res, error, 'get menus by month controller');
    }
  }
}
